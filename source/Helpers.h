...
void writeBufferToStream(ComputeSystem &cs, std::ostream &os, cl::Buffer &buf, cl::size_t size);
void readBufferFromStream(ComputeSystem &cs, std::istream &is, cl::Buffer &buf, cl::size_t size);
} // namespace ogmaneo