...
void writeBufferToStream(ComputeSystem &cs, std::ostream &os, cl::Buffer &buf, cl_size_t size);
void readBufferFromStream(ComputeSystem &cs, std::istream &is, cl::Buffer &buf, cl_size_t size);
} // namespace ogmaneo