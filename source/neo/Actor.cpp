...
void Actor::learn(const Int2 &pos, std::mt19937 &rng, const std::vector<const IntBuffer*> &inputs, const std::vector<const IntBuffer*> &inputsPrev, const IntBuffer* hiddenCsPrev, float reward) {
    // New Q
